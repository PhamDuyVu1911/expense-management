<form action="plan/create" class="form-wrapper" method="POST" enctype="multipart/form-data">
    ...
    <div class="">
        <div class="form-group mt-20">
            ...
            <input type="text" placeholder="Nhập tên kế hoạch chi tiêu" name="name">
        </div>
        <div class="form-group mt-20">
            <label for="">
                Số tiền
        ...
        <div class="form-group mt-20">
            ...
            <input type="date" placeholder="Nhập thời gian" name="time">
        </div>
